...
public class SwerveModule extends SubsystemBase {
  ...
  public SwerveModule(
    ...
    canCoder = new CANCoder(canCoderDeviceNumber);
    CANCoderConfiguration canCoderConfig = new CANCoderConfiguration();
//FOLLOWING CODE IS SOME RANDOM CONFIGURATION; WHY DO WE NEED IT?
    // canCoderConfig.velocityMeasurementPeriod = CANCoderVelocityMeasPeriod.Period_100Ms;
    // canCoderConfig.velocityMeasurementWindow = 64;
    // canCoderConfig.absoluteSensorRange = CANCoderAbsoluteSensorRange.Unsigned_0_to_360;
    // canCoderConfig.magnetOffsetDegrees = 0.0;
    // canCoderConfig.sensorCoefficient = 360.0 / 4096.0;
    // canCoderConfig.motorCommutation = CANCoderMagnetFieldCommutation.Trapezoidal_150us;
    // canCoder.configAllSettings(canCoderConfig);
    double canCoderPosition = canCoder.getPosition();
